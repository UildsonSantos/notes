...
class DatabaseHelper {
  ...
  Future<Either<Failure, NoteModel>> add(NoteModel note) async {
    try {
      ...
      return Right(noteWithId);
    } catch (e) {
      return const Left(DatabaseFailure('Failed to add note'));
    }
  }
  ...
  Future<Either<Failure, List<NoteModel>>> get() async {
    try {
      ...
      return const Left(DatabaseFailure('Failed to get notes'));
    }
  }
  ...
  Future<Either<Failure, int>> update(NoteModel note) async {
    try {
      ...
      return const Left(DatabaseFailure('Failed to update note'));
    }
  }
  ...
  Future<Either<Failure, int>> delete(int id) async {
    try {
      ...
      return const Left(DatabaseFailure('Failed to delete note'));
    }
  }
}
